...
# #правильно ли я понимаю, что атрибут у класса - это количество ячеек, иначе -не понятно.

    def make_order(self,quantity_in_row):
        row = " "
        n = int(self.quantity / quantity_in_row)
        n_1 = int(self.quantity % quantity_in_row)
...
#почему-то не выводит сумму и деление. не ясно как организовать вывод в таком случае